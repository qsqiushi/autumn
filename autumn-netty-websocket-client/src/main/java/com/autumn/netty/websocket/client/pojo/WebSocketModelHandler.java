...
public class WebSocketModelHandler implements ChannelInboundHandler {
  ...
  public WebSocketModelHandler(
      String id,
      WebSocketClientHandshaker webSocketClientHandshaker,
      WebSocketModelCache webSocketModelCache,
      ContextConverter contextConverter) {
    this.webSocketModelCache = webSocketModelCache;
    this.contextConverter =
        contextConverter == null ? new WebSocketActuatorDefault() : contextConverter;
    ...
    try {
      ...
      if (!webSocketClientHandshaker.isHandshakeComplete()) {
        ...
        if (id != null) {
          ...
          contextConverter.converterOnError(
              webSocket,
              new Exception(
