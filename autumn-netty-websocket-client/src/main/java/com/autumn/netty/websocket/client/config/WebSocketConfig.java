...
public class WebSocketConfig {
    ...
    public WebSocketConfig(String url, Map<String, Object> httpHeaders, WebSocketActuatorBase actuator) {
        try {
            this.setUri(new URI(url));
            this.addHttpHeaders(httpHeaders);
            this.setActuator(actuator);
    ...
    public WebSocketConfig(URI uri, Map<String, Object> httpHeaders, List<Cookie> cookies, WebSocketActuatorBase actuator) {
        this.setUri(uri);
        this.addHttpHeaders(httpHeaders);
        this.addCookies(cookies);
        this.setActuator(actuator);
    ...
    public WebSocketConfig(String url, Map<String, Object> httpHeaders, List<Cookie> cookies, WebSocketActuatorBase actuator) {
        try {
            this.setUri(new URI(url));
            this.addHttpHeaders(httpHeaders);
            this.addCookies(cookies);
