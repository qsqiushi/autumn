package com.autumn.netty.websocket.standard;

import com.autumn.netty.websocket.annotation.ServerEndpoint;
import com.autumn.netty.websocket.exception.DeploymentException;
import com.autumn.netty.websocket.pojo.PojoEndpointServer;
import com.autumn.netty.websocket.pojo.PojoMethodMapping;
...
public class ServerEndpointExporter extends ApplicationObjectSupport
    ...
    private void init() {
        for (Map.Entry<InetSocketAddress, WebsocketServer> entry : addressWebsocketServerMap.entrySet()) {
            ...
            try {
                ...
                pojoEndpointServer.getPathMatcherSet()
    ...
    private ServerEndpointConfig buildConfig(ServerEndpoint annotation) {
        ...
        ServerEndpointConfig serverEndpointConfig = new ServerEndpointConfig(host, port, path, bossLoopGroupThreads,
            workerLoopGroupThreads, useCompressionHandler, optionConnectTimeoutMillis, optionSoBacklog,
            childOptionWriteSpinCount, childOptionWriteBufferHighWaterMark, childOptionWriteBufferLowWaterMark,
            childOptionSoRcvbuf, childOptionSoSndbuf, childOptionTcpNodelay, childOptionSoKeepalive,
            childOptionSoLinger, childOptionAllowHalfClosure, readerIdleTimeSeconds, writerIdleTimeSeconds,
            allIdleTimeSeconds, maxFramePayloadLength);
