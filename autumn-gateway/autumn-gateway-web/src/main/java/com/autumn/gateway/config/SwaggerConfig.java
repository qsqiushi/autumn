...
public class SwaggerConfig {
  ...
  public Docket api() {
    return new Docket(DocumentationType.OAS_30)
        ...
        .select()
        /**
         * RequestHandlerSelectors,配置要扫描接口的方式 basePackage指定要扫描的包 any()扫描所有，项目中的所有接口都会被扫描到 none()不扫描
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder()
        .title("接口文档")
        .description("@author qiushi")
        .contact(new Contact("qiushi", "https://github.com/qsqiushi/autumn", "qsqiushi@gmail.com"))
        .version("1.0")
        .build();
  }
