...
/** @author Spencer Gibb */
public class AirlookPathRoutePredicateFactory
    extends AbstractRoutePredicateFactory<AirlookPathRoutePredicateFactory.Config> {
  ...
  public AirlookPathRoutePredicateFactory() {
    super(Config.class);
  }
