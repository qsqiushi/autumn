 ...
 * @description: org.springframework.web.reactive.function.server.DefaultServerRequest
 * @author: qius
 * @create: 2020-01-20:08:39
 **/
...
class DefaultServerRequest implements ServerRequest {
    ...
    private static final Function<UnsupportedMediaTypeException, UnsupportedMediaTypeStatusException> ERROR_MAPPER =
        ex -> (ex.getContentType() != null ? new UnsupportedMediaTypeStatusException(ex.getContentType(),
            ex.getSupportedMediaTypes(), ex.getBodyType()) : new UnsupportedMediaTypeStatusException(ex.getMessage()));
