...
public class Server {
  ...
  public static String sign(
      String appKey, String appSecret, HttpServletRequest request, HttpMethodName httpMethodName)
      throws Exception {
  ...
  private static String head(
      String appKey, String appSecret, HttpServletRequest httpServletRequest) {
