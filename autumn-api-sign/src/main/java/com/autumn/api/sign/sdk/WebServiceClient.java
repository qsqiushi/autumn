...
import com.autumn.api.sign.sdk.http.ExecutionContext;
import com.autumn.api.sign.sdk.http.InnerHttpClient;
import com.autumn.api.sign.sdk.http.RequestHandler;
...
public abstract class WebServiceClient {
  ...
  private Signer computeSignerByServiceRegion(String serviceName, String signerRegionOverride) {
    ...
    Signer signer =
        signerType == null
            ? SignerFactory.getSigner(serviceName, signerRegionOverride)
