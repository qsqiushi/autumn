...
package com.autu.api.sign.sdk.http.conn.ssl;

import com.autu.api.sign.sdk.annotation.ThreadSafe;
import com.autu.api.sign.sdk.http.conn.SdkSocket;
import com.autu.api.sign.sdk.http.conn.SdkSSLSocket;
...
public class TLSSocketFactory extends SSLSocketFactory {
    ...
    public Socket connectSocket(Socket socket, InetSocketAddress remoteAddress, InetSocketAddress localAddress,
        ...
        return (Socket)(socket instanceof SSLSocket ? new SdkSSLSocket((SSLSocket)socket) : new SdkSocket(socket));
    }
                ...
                if ("sun.security.ssl.SSLSessionImpl".equals(className)) {
                    try {
                        ...
                        if (masterSecret == null) {
                            throw (SecurityException)this.log(new SecurityException("Invalid SSL master secret"));
                        }
