...
public class Client {
    ...
    public static HttpRequestBase patch(String ak, String sk, String requestUrl, Map<String, String> headers,
    ...
    public static okhttp3.Request signOkhttp(Request request) throws Exception {
        return okhttpRequest(request.getMethod(), request.getKey(), request.getSecret(), request.getUrl(),
